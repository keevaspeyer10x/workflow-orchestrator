...
```bash
orchestrator prd report-complete manual-78e31216 --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-78e31216 --error "Description of what went wrong"
```
