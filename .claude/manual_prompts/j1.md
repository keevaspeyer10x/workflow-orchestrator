...
```bash
orchestrator prd report-complete manual-c91d37e5 --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-c91d37e5 --error "Description of what went wrong"
```
