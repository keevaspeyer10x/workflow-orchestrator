...
```bash
orchestrator prd report-complete manual-cab70057 --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-cab70057 --error "Description of what went wrong"
```
