...
```bash
orchestrator prd report-complete manual-baccface --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-baccface --error "Description of what went wrong"
```
