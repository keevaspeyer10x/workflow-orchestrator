...
```bash
orchestrator prd report-complete manual-7be748c5 --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-7be748c5 --error "Description of what went wrong"
```
