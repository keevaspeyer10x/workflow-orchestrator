...
```bash
orchestrator prd report-complete manual-c9485884 --branch <branch-name> --commit <commit-sha>
```

Or if the task failed:

```bash
orchestrator prd report-failed manual-c9485884 --error "Description of what went wrong"
```
